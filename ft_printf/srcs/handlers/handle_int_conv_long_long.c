...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   handle_int_conv_long_long.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: apion <apion@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/16 18:57:52 by apion             #+#    #+#             */
/*   Updated: 2019/02/12 23:52:51 by apion            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		fill_str(long long value, char *base, char *str, t_specs *specs)
{
	int		b;
	int		i;
	int		j;
...
int				handle_int_conv_long_long(long long value, t_specs *specs,
											char *str)
{
	char		*base;
